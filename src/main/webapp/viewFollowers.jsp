...
<body>
 ...
 <div class="section">
    <div class="container mt-4">
        <h2 class="text-center">My Followers Report</h2>
        <hr>
...
<soham:choose>
    <soham:when test="${not empty stal}">
             ...
             onclick="showPhoto('Uploads/${rec.path}')">
                        ...
                        <td>
                            <a href="Stud_Profile_for_Following.jsp?&userid=${rec.userid}&username=${rec.usernm}" class="btn btn-success btn-sm">View Profile</a>
                        </td>
