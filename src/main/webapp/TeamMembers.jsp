...
<div class="col-md-3">
    ...
    <div class="main-content">
        ...
        <div class="section">
              ...
              <h3 class="text-center mb-4">Team Members</h3>
    ...
    String qr="select usernm,branch,mobileno,emailid,photo,currentsts,job_post,job_details,userid from  studentpersonal where userid in (select userid1 from requests where proj_id="+pid+" and sts='accepted')";
        ...
        if(cnt%4==0){
          ...
          <td>  <div class="col-md-12 mb-4">
                <div class="card alumni-card"> 
                      ...
                      <a href="NewReview?userid=<%=v.elementAt(i+8).toString().trim() %>&username=<%=v.elementAt(i).toString().trim() %>" class="button follow">Reviews</a>
