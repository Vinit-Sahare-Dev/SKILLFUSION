                    ...
                    <div class="collapse navbar-collapse bg-transparent" id="navbarCollapse">
                        <div class="navbar-nav ms-auto mx-xl-auto p-0">
                            <a href="<%=session.getAttribute("usertype") %>" class="nav-item nav-link active text-secondary">Home</a>
                             ...
                             <a href="govtExamCategories" class="nav-item nav-link">Government Exam Categories</a>
                             <a href="govtExams" class="nav-item nav-link">Government Exams</a>
                             <a href="registerSuccessStories" class="nav-item nav-link">Success Stories</a>
                           ...
                           <div class="nav-item dropdown">
      						...
      						<div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu rounded"> 
                                    ...
                                    <a href="viewAlumni" class="dropdown-item">Alumni Report</a>
                      ...
                      <a href="uploadDocs" class="nav-item nav-link">Upload Content</a>
                            ...
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Followings</a>
                                <div class="dropdown-menu rounded"> 
                                     <a href="followings" class="dropdown-item">My Followings</a>
                                   
                                </div>
                            </div>
                            <%} else if(session.getAttribute("usertype").toString().trim().equals("alumni")){ %>
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Followers</a>
                                <div class="dropdown-menu rounded"> 
                                    <a href="pendingFollowers" class="dropdown-item">Pending Followers</a>
                                    <a href="followers" class="dropdown-item">Followers Report</a>
                             ...
                             <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu rounded"> 
                                     <a href="Forum.jsp" class="dropdown-item">Forum</a>
...
<div class="col-md-3">
    ...
    <div class="sidebar">
        ...
        <img src='Uploads/<%=session.getAttribute("photo").toString() %>' class="img-responsive img-thumbnail rounded-circle" width="100px"/>
            <h2><%=session.getAttribute("username").toString() %>
            (<%=session.getAttribute("usertype").toString().trim()%>)
            </h2>
