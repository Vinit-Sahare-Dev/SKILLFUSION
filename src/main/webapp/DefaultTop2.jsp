...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid bg-dark py-2 d-none d-md-flex">
            <div class="container">
                <div class="d-flex justify-content-between topbar">
                    ...
                    <div id="note" class="text-secondary d-none d-xl-flex"><small>  </small></div>
                    <div class="top-link">
                            </div>
                </div>
            </div>
        ...
        <div class="container-fluid contact-detail position-relative p-5"> 
      ...
      <h2><span class="homeHeader">  </span> Home </h2></center>  
       </div> --> 
