 ...
 <div class="section">
    <div class="container mt-4">
          <h3>Register/Update Skills</h3>
            <form name="frm" method="post" action="RegSkills">
            <div class="row">
             <%
             JavaFuns jf=new JavaFuns();
             Vector v5=jf.getValue("select skill from stud_skills  where userid='"+session.getAttribute("userid").toString().trim()+"'", 1);
