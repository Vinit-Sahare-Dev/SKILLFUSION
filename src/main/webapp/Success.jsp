...
else if(request.getAttribute("activity").toString().trim().equals("ResumeReg"))
{
	%>
...
else if(request.getAttribute("activity").toString().trim().equals("approveFollower"))
{
	%>
	Follower Request Approved Successfully...
	
	<%
}
else if(request.getAttribute("activity").toString().trim().equals("declineFollower"))
{
	%>
	Follower Request Declined Successfully...
	
	<%
}
else if(request.getAttribute("activity").toString().trim().equals("reqReg"))
{
	%>
...
else if(request.getAttribute("activity").toString().trim().equals("reqaccepted"))
{
	%>
...
else if(request.getAttribute("activity").toString().trim().equals("ProjReg"))
{
	%>
...
else if(request.getAttribute("activity").toString().trim().equals("compose"))
{
	%>
...
else if(request.getAttribute("activity").toString().trim().equals("ExamsReg"))
{
	%>
	Exams Registered Successfully...
	<%
}
...
}else if(request.getAttribute("activity").toString().trim().equals("changePass"))
{
	...
	<%
}else if(request.getAttribute("activity").toString().trim().equals("expReg"))
{
	%>
	Experience Stored Successfully...
	<%
}else if(request.getAttribute("activity").toString().trim().equals("AchievReg"))
{
	%>
	Achievements Stored Successfully...
	<%
}
...
{  
	...
	else if(usertype.equals("WorkingProfessional")){
		%>
		<a href="WorkingProfessional.jsp" class="btn btn-secondary">Home</a>
		<%
	}
...
catch(Exception ex)
{
 ...
 <button onclick="window.location.replace(document.referrer)" class="btn btn-secondary">Go Back</button>
 <script>
  function goBack() {
    window.history.back();
