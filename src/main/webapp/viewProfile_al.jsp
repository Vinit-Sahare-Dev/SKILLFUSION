...
<div class="col-md-3">
	...
	<div class="section">
             <%
             String qr1="select  ";
            		qr1+=" (select count(*) from follows where follower_id='"+session.getAttribute("userid").toString().trim() +"') as followings,";
            		 qr1+=" (select count(*) from follows where following_id='"+session.getAttribute("userid").toString().trim() +"') as followers,";
            				 qr1+=" (select count(*) from posts where userid='"+session.getAttribute("userid").toString().trim() +"') as posts";
            				 //JavaFuns jf=new JavaFuns();
    ...
    <div class="main-container" id="maincontainer">
        ...
        <!-- Education Section -->
        <div class="info-section" id="education" style="visibility: hidden;position: absolute;">
            <h4>Education</h4>
            <br>
...
<div class="info-section" id="accomplishments" style="visibility: hidden;position: absolute;">
...
<div class="info-section" id="resume" style="visibility: hidden;position: absolute;">
    <h3>Resume</h3>
    ...
    <button id="addResumeBtn" class="add-btn" style="visibility: hidden;position: absolute;">Add Resume</button>
