...
<div class="col-md-3">
    ...
    <div class="main-content">
        ...
        <div class="section">
            ...
            <div class="post-options">
                <button class="button" onclick="openPopup('post')">Post Question</button>
                <br/>
               
                <%JavaFuns jf1=new JavaFuns();
                Vector vp=jf1.getValue("select * from forum_ques order by qid desc", 8);
                
                %> </div><div class="post-options">
                <table class="table table-bordered">
                 
                <% for(int i=0;i<vp.size();i=i+8){ %>
                <tr>
                <td colspan="2"><h2><a href="ShowQues.jsp?quesid=<%=vp.elementAt(i).toString() %>&ques=<%=vp.elementAt(i+4).toString() %>"><%=vp.elementAt(i+4).toString() %></a></h2></td>
               </tr><tr> <td colspan="2">Posted by <%=vp.elementAt(i+2).toString() %>(<%=vp.elementAt(i+3).toString() %>)
    ...
    <div id="popup-overlay" class="popup-overlay">
        ...
        <button class="close" onclick="closePopup('post')">Close</button>
            ...
            <form name="frm" method="post" action="Regques">
            <textarea name="ques" required placeholder="Write your Question"></textarea>
