...
<div class="col-md-3">
	...
	<p><b>Branch : <%=session.getAttribute("branch").toString().trim() %></b></p>
                    <p><b>User Type: <%=session.getAttribute("usertype").toString().trim() %></b></p>
                     ...
                     Vector v=jf.getValue("select mobileno,emailid from studentpersonal where userid='"+session.getAttribute("userid").toString().trim()+"'", 2);
                     
                     %>
                     <p><b>Mobile No: <%=v.elementAt(0).toString().trim() %></b></p>
                     <p><b>Email Id : <%=v.elementAt(1).toString().trim() %></b></p>
