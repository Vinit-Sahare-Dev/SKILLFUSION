...
<body>
 ...
 <div class="section">
    <div class="container mt-4">
        <h2 class="text-center">Pending Followers Report</h2>
        <hr>
        ...
        <table class="table table-bordered text-center">
            ...
            <tbody>
<soham:choose>
    <soham:when test="${not empty stal}">
             ...
             onclick="showPhoto('Uploads/${rec.path}')">
                        ...
                        <td>
                            <a href="approveFollower?followId=${rec.followId}&userid=${rec.userid}&usernm=${rec.usernm}&email=${rec.emailid}" class="btn btn-success btn-sm">Approve</a>
                        </td>
                        <td>
                            <a href="declineFollower?followId=${rec.followId}&userid=${rec.userid}&usernm=${rec.usernm}&email=${rec.emailid}" class="btn btn-success btn-sm">Decline</a>
                        </td>
                    </tr>
                </soham:forEach>
</soham:when>
